...
public final /* synthetic */ class ReverseChargingController$$ExternalSyntheticLambda3 implements Runnable {
    public final /* synthetic */ ReverseChargingController f$0;
    public final /* synthetic */ Bundle f$1;

    public /* synthetic */ ReverseChargingController$$ExternalSyntheticLambda3(ReverseChargingController reverseChargingController, Bundle bundle) {
    ...
    public final void run() {
        ...
        if (!reverseChargingController.mReverse && reverseChargingController.mWirelessCharging && i4 == 0 && i7 > 0) {
            ...
            if (TextUtils.isEmpty(reverseChargingController.mName)) {
                reverseChargingController.mName = reverseChargingController.mContext.getString(2131953658);
            }
            ...
            if (i8 == 1 && i4 != 1 && reverseChargingController.mReverse) {
                ...
                RecordingInputConnection$$ExternalSyntheticOutline0.m("Reverse charging error happened : ", i5, "ReverseChargingControl");
            ...
            if (i4 == 1) {
                ...
                if (z3 || !z2) {
                    ...
                    if (!reverseChargingController.mStartReconnected || !(i6 == 16 || i6 == 90 || i6 == 114)) {
                        str2 = reverseChargingController.mContext.getString(2131953661);
                    } else {
                        str2 = null;
                    }
                ...
                if (!z2) {
                    ...
                    if (reverseChargingController.mCurrentRtxReceiverType != i6) {
                        ...
                        if (z) {
                            ExifInterface$$ExternalSyntheticOutline0.m("logReverseAccessoryType: ", i6, "ReverseChargingControl");
                        }
                        if (i6 != 0) {
