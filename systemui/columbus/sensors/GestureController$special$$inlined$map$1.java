...
public final class GestureController$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ GestureController$special$$inlined$map$1(int i, Object obj) {
        this.$r8$classId = i;
    ...
    public final Object collect(final FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            case 0:
                Object collect = ((Flow) this.$this_unsafeTransform$inlined).collect(new FlowCollector() {
