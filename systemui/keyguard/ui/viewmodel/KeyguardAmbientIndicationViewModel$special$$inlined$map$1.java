...
public final class KeyguardAmbientIndicationViewModel$special$$inlined$map$1 implements Flow {
    ...
    public /* synthetic */ KeyguardAmbientIndicationViewModel$special$$inlined$map$1(Flow flow, int i) {
        this.$r8$classId = i;
    ...
    public final Object collect(final FlowCollector flowCollector, Continuation continuation) {
        switch (this.$r8$classId) {
            ...
            default:
                Object collect2 = this.$this_unsafeTransform$inlined.collect(new KeyguardAmbientIndicationViewModel$special$$inlined$map$2$2(flowCollector), continuation);
