...
public final class LauncherTileService$stub$1$addTileListener$1 implements Runnable {
    ...
    public LauncherTileService$stub$1$addTileListener$1(LauncherTileService$stub$1 launcherTileService$stub$1, String str, ILauncherTileListener iLauncherTileListener) {
    ...
    public final void run() {
        ...
        ILauncherTileListener iLauncherTileListener = this.$listener;
        ...
        if (tile == null) {
            ...
            ((ILauncherTileListener$Stub$Proxy) iLauncherTileListener).onTileUpdated(tileState);
            return;
        }
        LauncherTileService launcherTileService = launcherTileService$stub$1.this$0;
        LauncherTileService$stub$1$addTileListenerInternal$callback$1 launcherTileService$stub$1$addTileListenerInternal$callback$1 = new LauncherTileService$stub$1$addTileListenerInternal$callback$1(str, launcherTileService, iLauncherTileListener);
