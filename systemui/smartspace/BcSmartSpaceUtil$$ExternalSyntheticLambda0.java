...
public final /* synthetic */ class BcSmartSpaceUtil$$ExternalSyntheticLambda0 implements View.OnClickListener {
    ...
    public final /* synthetic */ TapAction f$3;
    ...
    public final /* synthetic */ SmartspaceTarget f$7;

    public /* synthetic */ BcSmartSpaceUtil$$ExternalSyntheticLambda0(BcSmartspaceCardLoggingInfo bcSmartspaceCardLoggingInfo, int i, String str, TapAction tapAction, boolean z, BcSmartspaceDataPlugin.SmartspaceEventNotifier smartspaceEventNotifier, SmartspaceTarget smartspaceTarget) {
        this.f$0 = bcSmartspaceCardLoggingInfo;
        this.f$1 = i;
        this.f$2 = str;
        this.f$3 = tapAction;
        this.f$4 = z;
        this.f$6 = smartspaceEventNotifier;
        this.f$7 = smartspaceTarget;
    }
    ...
    public final void onClick(View view) {
        ...
        if (falsingManager == null || !falsingManager.isFalseTap(1)) {
            ...
            if (intentStarter == null) {
                intentStarter = new BcSmartspaceDataPlugin.IntentStarter(str) {
                    public final void startIntent(
/*
Method generation error in method: com.google.android.systemui.smartspace.BcSmartSpaceUtil.1.startIntent(android.view.View, android.content.Intent, boolean):void, dex: classes2.dex
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.google.android.systemui.smartspace.BcSmartSpaceUtil.1.startIntent(android.view.View, android.content.Intent, boolean):void, class status: UNLOADED
...
/*
Method generation error in method: com.google.android.systemui.smartspace.BcSmartSpaceUtil.1.startPendingIntent(android.view.View, android.app.PendingIntent, boolean):void, dex: classes2.dex
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.google.android.systemui.smartspace.BcSmartSpaceUtil.1.startPendingIntent(android.view.View, android.app.PendingIntent, boolean):void, class status: UNLOADED
                    	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                    	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                    	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                    	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
