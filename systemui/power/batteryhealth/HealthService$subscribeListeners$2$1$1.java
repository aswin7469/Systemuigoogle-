...
final class HealthService$subscribeListeners$2$1$1 extends Lambda implements Function1 {
    final /* synthetic */ Pair $pair;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public HealthService$subscribeListeners$2$1$1(Pair pair) {
        super(1);
        this.$pair = pair;
    }
    ...
    public final Object invoke(Object obj) {
        int i = ((SharedPreferences) this.$pair.getFirst()).getInt("health_index", -1);
        ...
        try {
            ...
            obtain.writeInt(i);
            iHealthListener$Stub$Proxy.mRemote.transact(1, obtain, (Parcel) null, 1);
            obtain.recycle();
