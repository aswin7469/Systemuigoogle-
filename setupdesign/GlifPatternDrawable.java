...
public final class GlifPatternDrawable extends Drawable {
    ...
    public Bitmap createBitmapCache(int i, int i2) {
        ...
        if (patternPaths == null) {
            ...
            path5.lineTo(476.4f, 0.0f);
            path5.rLineTo(-5.3f, 768.0f);
            path5.close();
            Path[] pathArr5 = patternPaths;
            Path path6 = new Path();
            pathArr5[4] = path6;
            path6.moveTo(323.1f, 768.0f);
            path6.moveTo(777.5f, 768.0f);
            path6.cubicTo(661.9f, 348.8f, 427.2f, 21.4f, 401.2f, 25.4f);
            path6.lineTo(323.1f, 768.0f);
            path6.close();
            Path[] pathArr6 = patternPaths;
            Path path7 = new Path();
            pathArr6[5] = path7;
            path7.moveTo(178.44286f, 766.8571f);
            path7.lineTo(308.7f, 768.0f);
            path7.cubicTo(381.7f, 604.6f, 481.6f, 344.3f, 562.2f, 0.0f);
            path7.lineTo(0.0f, 0.0f);
            path7.close();
            Path[] pathArr7 = patternPaths;
            Path path8 = new Path();
            pathArr7[6] = path8;
            path8.moveTo(146.0f, 0.0f);
            path8.lineTo(0.0f, 0.0f);
            path8.lineTo(0.0f, 768.0f);
            path8.lineTo(394.2f, 768.0f);
            path8.cubicTo(327.7f, 475.3f, 228.5f, 201.0f, 146.0f, 0.0f);
            path8.close();
        }
    ...
    public final void draw(android.graphics.Canvas r9) {
        /*
            ...
            int r1 = r0.width()
            int r2 = r0.height()
            java.lang.ref.SoftReference r3 = bitmapCache
            r4 = 0
